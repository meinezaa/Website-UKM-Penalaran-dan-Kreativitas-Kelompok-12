    ...
    <main class="w-full max-w-5xl relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 bg-white rounded-[2rem] md:rounded-[3rem] overflow-hidden custom-shadow border border-gray-50">
            ...
            <div class="lg:col-span-7 p-8 md:p-16 flex flex-col justify-center">
                ...
                @if (session('sukses'))
                    <div class="mb-6 flex items-center gap-3 p-4 rounded-2xl text-xs font-bold border bg-green-50 text-green-700 border-green-100">
                ...
                @if ($errors->any())
                    <div class="mb-6 p-4 bg-red-50 text-red-700 border-red-200 border-l-4 text-xs font-bold rounded-r-xl">
