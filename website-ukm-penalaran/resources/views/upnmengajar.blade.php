            ...
            <ul class="flex gap-12 font-poppins font-semibold">
              ...
              <li class="relative group">
                ...
                >
                  ...
                  <li>
                    <a href="{{ url('/struktur') }}" class="block px-5 py-2 hover:bg-gray-100">
                      Tim UPN Mengajar
                    </a>
                  </li>
                </ul>
        ...
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid md:grid-cols-3 gap-10">
            <div class="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 card-hover transition duration-500">
                ...
                <img src="{{ asset('foto/sd.JPG') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" />
                </div>
                <div class="p-10">
                ...
                <div class="flex items-center mt-6">
                    <a href="{{ url('/relawan-sd') }}" class="bg-[#8B1E1E] text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-red-700 transition">
                    Lihat Detail
                    </a>
                </div>
                </div>
            ...
            <div class="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 card-hover transition duration-500">
                <div class="h-56 bg-gray-200 overflow-hidden relative">
                <img src="{{ asset('foto/slb.JPG') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" />
                ...
                <div class="flex items-center mt-6">
                    <a href="{{ url('/relawan-slb') }}" class="bg-[#8B1E1E] text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-red-700 transition">
                    Lihat Detail
                    </a>
                </div>
                </div>
            ...
            <div class="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 card-hover transition duration-500">
                <div class="h-56 bg-gray-200 overflow-hidden relative">
                <img src="{{ asset('foto/yayasan.jpg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" />
                </div>
                <div class="p-10">
                ...
                <div class="flex items-center mt-6">
                    <a href="{{ url('/relawan-yayasan') }}" class="bg-[#8B1E1E] text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-red-700 transition">
                    Lihat Detail
                    </a>
                </div>
                </div>
