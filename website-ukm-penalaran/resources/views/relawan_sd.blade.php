    ...
    <main class="max-w-7xl mx-auto px-6 pb-12 pt-32">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8 items-start">
        <div class="space-y-6">
          ...
          {{-- FIX FORM SECTION: MENERAPKAN STRUKTUR MULTI-STEP SESUAI CONTROLLER --}}
          <div id="form-pendaftaran" class="bg-white rounded-[20px] border border-gray-100 shadow-md p-6 md:p-8 scroll-mt-28">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-100 pb-4 mb-6 gap-4">
              <div>
                ...
                <p class="text-gray-500 text-sm">Lengkapi tahapan data berikut untuk bergabung.</p>
              </div>
            ...
            <form id="formRelawan" action="/pendaftaran/simpan" method="POST" enctype="multipart/form-data" class="space-y-5">
              ...
              {{-- STEP 1: DATA PERSONAL & JURUSAN & DIVISI --}}
              <div id="step-1" class="space-y-5">
                ...
                <div>
                  <label class="block text-sm font-semibold text-gray-700 mb-2">Pengalaman & Keahlian</label>
                  <textarea name="pengalaman_keahlian" rows="4" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-red-100 focus:border-[#8B1E1E] outline-none transition" placeholder="Ceritakan pengurus organisasi atau keahlian kepengurusanmu..." required></textarea>
                </div>
              </div>

              {{-- STEP 2: ADMINISTRASI / PEMBAYARAN --}}
              ...
              <div id="step-3" class="hidden space-y-5 text-center">
                ...
                <div class="bg-gray-50 p-5 rounded-xl text-left text-xs md:text-sm text-gray-600 border border-gray-100 space-y-2 leading-relaxed">
                  <p>1. Saya berkomitmen penuh untuk mengikuti rangkaian kegiatan kerelawanan UPN Mengajar.</p>
                  <p>2. Segala lampiran berkas serta bukti administrasi pendaftaran adalah absah dan benar adanya.</p>
                </div>
                <label class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl cursor-pointer border hover:border-red-200 transition text-left">
                  ...
                  <span class="text-xs md:text-sm font-medium text-gray-600 select-none">Saya menyatakan setuju dengan seluruh poin di atas.</span>
                </label>
              </div>

              {{-- NAVIGASI FOOTER INTERNAL CARD FORM --}}
