        ...
        <div class="flex items-center gap-12">
            <nav>
                <ul class="flex gap-12 font-poppins font-semibold">
                    <li><a href="{{ route('home') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">Home</a></li>
                    ...
                    <li class="relative group">
                        ...
                        <ul class="absolute left-0 mt-3 w-max bg-white text-gray-600 text-sm shadow-md opacity-0 invisible -translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-out">
                            ...
                            <li><a href="{{ route('tentang.struktur') }}" class="block px-5 py-2 bg-red-5 hover:bg-red-100">Tim UPN Mengajar</a></li>
                        </ul>
                    </li>
                    
                    <li><a href="{{ route('kegiatan') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">Kegiatan</a></li>
                    <li><a href="{{ route('relawan') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">Relawan</a></li>
                </ul>
            </nav>
...
<div class="h-24"></div>
    <section class="px-6 text-center">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="py-5">
                <div class="mt-8 overflow-hidden rounded-2xl shadow-2xl shadow-gray-200">
                    <img src="{{ asset('foto/Foto lengkap.jpg') }}" alt="all diksos" 
               ...
               <h2 class="mt-16 text-2xl font-semibold mb-10 uppercase">BPH BIDANG DIKSOS</h2>
                <div class="grid md:grid-cols-3 gap-8 mb-16">
                    <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition-shadow duration-300">
                        ...
                        <img src="{{ asset('foto/Ketua Bidang.jpeg') }}" 
                    ...
                    <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition-shadow duration-300">
                        <div class="overflow-hidden rounded-lg mb-4">
                            <img src="{{ asset('foto/Wakil Ketua Bidang.jpg') }}" 
                            class="w-full h-auto transform transition-transform duration-500 ease-out hover:scale-110">
                         </div>
                             <div class="text-center">
                    ...
                    <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition-shadow duration-300">
                         <div class="overflow-hidden rounded-lg mb-4">
                         <img src="{{ asset('foto/Sekretaris Bidang.jpg') }}" 
                         class="w-full h-auto transform transition-transform duration-500 ease-out hover:scale-110">
                        </div>
                            <div class="text-center">
           ...
           <section class="mb-16">
                ...
                <img src="{{ asset('foto/Staff Ahli Medsos Diksos.jpg') }}" 
                class="w-full h-auto transform transition-transform duration-500 ease-out hover:scale-110">
            </div>
            <div class="text-center">
        ...
        <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition-shadow duration-300">
            <div class="overflow-hidden rounded-lg mb-3">
                <img src="{{ asset('foto/Staff Ahli Bina Desa.jpg') }}" 
                class="w-full h-auto transform transition-transform duration-500 ease-out hover:scale-110">
            </div>
            <div class="text-center">
        ...
        <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition-shadow duration-300">
            <div class="overflow-hidden rounded-lg mb-3">
                <img src="{{ asset('foto/Staff Ahli UPN Mengajar.jpg') }}" 
                class="w-full h-auto transform transition-transform duration-500 ease-out hover:scale-110">
            </div>
            <div class="text-center">
        ...
        <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition-shadow duration-300">
            <div class="overflow-hidden rounded-lg mb-3">
                <img src="{{ asset('foto/Staff Ahlii Nalar Peduli.jpg') }}" 
                class="w-full h-auto transform transition-transform duration-500 ease-out hover:scale-110">
            </div>
            <div class="text-center">
