...
<html lang="id">
  ...
  <body>
        ...
        <div class="flex items-center gap-12">
          ...
          <nav>
            <ul class="flex gap-12 font-poppins font-semibold">
              ...
              <li>
                <a href="{{ route('home') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                  Home
                </a>
              </li>

              <li class="relative group">
                <a href="{{ route('tentang') }}" class="flex items-center gap-1 relative after:absolute after:right-0 after:-bottom-1 after:h-[1.5px] after:w-full after:bg-white">
                  Tentang
              ...
              <li>
                <a href="{{ route('kegiatan') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                  Kegiatan
                </a>
              </li>

              <li>
                <a href="{{ route('relawan') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                  Relawan
                </a>
              </li>
    ...
    <section id="beranda">
      ...
      <p>
        Program ini bertujuan Mengembangkan potensi mahasiswa dalam bidang akademik, kreativitas, serta pengabdian masyarakat agar mampu memberi dampak nyata baik di kampus maupun di luar kampus.
      </p>
    ...
    <section id="tentang">
      ...
      <a href="{{ route('tentang.upnmengajar') }}">
        ...
        <div class="md:pl-10">
          ...
          <div class="space-y-3 text-sm">
            <div class="flex items-center gap-2">
              <img src="{{ asset('foto/Untitled design (17).png') }}" class="w-4 h-4">
            ...
            <div class="flex items-center gap-2">
              <img src="{{ asset('foto/instagram.png') }}" class="w-4 h-4">
            ...
            <div class="flex items-center gap-2">
              <img src="{{ asset('foto/whatsapp.png') }}" class="w-4 h-4">
