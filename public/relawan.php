    ...
    <main class="pt-[140px] md:pt-[160px]">
      ...
      >
        <div class="absolute inset-0 -z-10">
          ...
          ></div>
          <div
            class="absolute top-[40px] right-[-100px] w-[380px] h-[380px] bg-rose-200/30 rounded-full blur-3xl"
          ></div>
          <div
            class="absolute bottom-[-120px] left-[25%] w-[420px] h-[420px] bg-orange-100/30 rounded-full blur-3xl"
          ></div>
        </div>
        ...
        <section class="px-6 md:px-20 pb-10 bg-transparent">
          <div class="max-w-4xl">
            <span
              class="inline-block px-5 py-2 rounded-full bg-red-100 text-[#8B1E1E] text-sm font-semibold shadow-sm"
            >
              Program Relawan
            </span>

            <h1
              class="mt-4 text-4xl md:text-6xl font-bold text-[#8B1E1E] leading-tight"
            >
              Pilih Program Mengajar yang Paling Cocok Untukmu
            </h1>

            <p
              class="mt-5 text-gray-700 text-sm md:text-xl leading-relaxed max-w-3xl"
            >
              Bergabunglah sebagai relawan UPN Mengajar dan ambil peran dalam
              menciptakan pengalaman belajar yang bermakna bagi anak-anak di
          ...
          <div class="grid gap-10">
            ...
            >
              <div class="w-full h-72 md:h-[420px] overflow-hidden rounded-2xl">
                <img
                  src="./foto/slb.jpg"
                  alt="Program Sekolah Luar Biasa"
                  class="w-full h-full object-cover hover:scale-105 transition duration-500"
                />
              </div>
            ...
            >
              <div class="w-full h-72 md:h-[420px] overflow-hidden rounded-2xl">
                <img
                  ...
                  alt="Program Yayasan dan Komunitas"
                  class="w-full h-full object-cover hover:scale-105 transition duration-500"
                />
              </div>
