...
<!-- set pertama -->
<img src="foto/kegiatan1.jpg" class="aspect-[3/4] h-96 object-cover">
<img src="foto/kegiatan2.jpg" class="aspect-[3/4] h-96 object-cover">
<img src="foto/kegiatan3.jpg" class="aspect-[3/4] h-96 object-cover">
<img src="foto/kegiatan4.jpg" class="aspect-[3/4] h-96 object-cover">
<img src="foto/kegiatan5.jpg" class="aspect-[3/4] h-96 object-cover">
...
<!-- set 1 -->
<img src="foto/kegiatan6.jpg" class="aspect-[3/4] h-96 object-cover flex-shrink-0">
<img src="foto/kegiatan7.jpg" class="aspect-[3/4] h-96 object-cover flex-shrink-0">
<img src="foto/kegiatan8.jpg" class="aspect-[3/4] h-96 object-cover flex-shrink-0">
<img src="foto/kegiatan9.jpg" class="aspect-[3/4] h-96 object-cover flex-shrink-0">
  ...
  <div class="relative max-w-5xl mx-auto px-1 z-10">
    ...
    <div class="flex flex-col md:flex-row h-auto md:h-[420px] gap-6 md:gap-x-4">
      ...
      <div class="group relative flex-1 transition-all duration-500 hover:flex-[3] cursor-pointer rounded-2xl overflow-hidden h-64 md:h-auto">
        <img src="foto/foto1.jpg" class="absolute w-full h-full object-cover rounded-2xl">
        <div class="absolute inset-0 bg-black/30 rounded-2xl"></div> <!-- overlay foto -->
      ...
      <!-- ITEM 2 -->
      <div class="group relative flex-1 transition-all duration-500 hover:flex-[3] cursor-pointer rounded-2xl overflow-hidden h-64 md:h-auto">
        <img src="foto/foto2.jpg" class="absolute w-full h-full object-cover rounded-2xl">
      ...
      <!-- ITEM 3 -->
      <div class="group relative flex-1 transition-all duration-500 hover:flex-[3] cursor-pointer rounded-2xl overflow-hidden h-64 md:h-auto">
        <img src="foto/foto3.jpg" class="absolute w-full h-full object-cover rounded-2xl">
        <div class="absolute inset-0 bg-black/30 rounded-2xl"></div>
        <div class="absolute bottom-4 left-4 right-4 text-left text-white transition-all">
      ...
      <!-- ITEM 4 -->
      <div class="group relative flex-1 transition-all duration-500 hover:flex-[3] cursor-pointer rounded-2xl overflow-hidden h-64 md:h-auto">
        <img src="foto/foto4.jpg" class="absolute w-full h-full object-cover rounded-2xl">
        <div class="absolute inset-0 bg-black/30 rounded-2xl"></div>
        <div class="absolute bottom-4 left-4 right-4 text-left text-white transition-all">
      ...
      <!-- ITEM 5 -->
      <div class="group relative flex-1 transition-all duration-500 hover:flex-[3] cursor-pointer rounded-2xl overflow-hidden h-64 md:h-auto">
        <img src="foto/foto5.jpg" class="absolute w-full h-full object-cover rounded-2xl">
        <div class="absolute inset-0 bg-black/30 rounded-2xl"></div>
        <div class="absolute bottom-4 left-4 right-4 text-left text-white transition-all">
    ...
    <div class="md:pl-10">
      ...
      <div class="space-y-3 text-sm">
        ...
        <div class="flex items-center gap-2">
          <img src="foto/email.png" class="w-5 h-6">
...
function typeWriter(){
  ...
  if(i < text.length){
    ...
    // delay random supaya terasa seperti manusia
