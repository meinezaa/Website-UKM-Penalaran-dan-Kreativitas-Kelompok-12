...
if (isset($_SESSION['id_user'])) {
    // Cek rolenya, supaya tidak salah lempar halaman
...
<body class="bg-surface font-body text-on-surface min-h-screen relative flex items-center justify-center py-12 px-4">
    ...
    <main class="w-full max-w-6xl">
        <div class="grid grid-cols-1 md:grid-cols-2 bg-white rounded-[2.5rem] overflow-hidden editorial-shadow border border-gray-100">
            ...
            <!-- Sisi Kiri: Editorial Image (Sama dengan Register) -->
            <div class="hidden md:flex flex-col justify-between p-12 bg-gray-900 relative group" 
                 style="background-image: url('foto/foto3.jpg'); background-size: cover; background-position: center;">
            ...
            <div class="p-10 md:p-16 flex flex-col justify-center">
                ...
                <form action="" method="POST" class="space-y-5">
                    ...
                    <!-- Tombol Submit -->
                    <button type="submit" name="login" class="w-full bg-primary hover:bg-red-700 text-white font-headline font-bold py-4 rounded-2xl shadow-xl shadow-red-100 active:scale-[0.98] transition-all flex items-center justify-center gap-2 mt-2 text-sm uppercase tracking-widest">
                        Masuk Ke Akun
                ...
                <div class="mt-10 pt-8 border-t border-gray-50 text-center">
                    <p class="text-xs text-on-surface-variant font-medium">
                        Belum punya akun? <a href="register.php" class="text-primary font-bold hover:underline">Daftar Akun</a>
                    </p>
                </div>
            </div>
        </div>
