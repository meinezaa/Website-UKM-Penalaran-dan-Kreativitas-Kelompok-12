...
<html lang="id">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Instrument+Serif&family=Poppins:wght@300;400;500;600;700&display=swap"
      rel="stylesheet"
    />
 ...
 <!-- header -->
    <header>
      <div>
        <img src="./foto/logo.jpeg" alt="Logo UPN Mengajar" />
        <h1>UPN Mengajar</h1>
        <p>
  ...
  <ul>
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a href="upnmengajar.html">Tentang UPN Mengajar</a></li>
        <li><a href="ukm.html">UKM Penalaran & Kreativitas</a></li>
        <li><a href="tim.html">Tim UPN Mengajar</a></li>
...
<!-- STRUKTUR ORGANISASI -->
<section>
    <h2>UKM Penalaran & Kreativitas</h2>
    <div class="org-container">
        <div class="org-card">
            <img src="profile.jpg" alt="ketua ukm">
            <h3>Nama Ketua</h3>
            <p>Ketua Umum</p>
        </div>

    <div class="org-card">
        <img src="profile.jpg" alt="wakil ukm">
        <h3>Nama Wakil</h3>
        <p>Wakil Ketua</p>
    </div>

    <div class="org-card">
        <img src="profile.jpg" alt="sekretaris 1">
        <h3>Nama Sekretaris 1</h3>
        <p>Sekretaris 1</p>
    </div>

     <div class="org-card">
        <img src="profile.jpg" alt="sekretaris 2">
        <h3>Nama Sekretaris 2</h3>
        <p>Sekretaris 2</p>
    </div>

    <div class="org-card">
        <img src="profile.jpg" alt="bendahara 1">
        <h3>Nama Bendahara 1</h3>
        <p>Bendahara 1</p>
    </div>

    <div class="org-card">
        <img src="profile.jpg" alt="bendahara 2">
        <h3>Nama Bendahara 2</h3>
        <p>Bendahara 2</p>
    </div>
...
<<<<<<< HEAD
    ...
    <section id="beranda">
      ...
      <p>
        Program Pengabdian Pendidikan oleh UKM Penalaran dan Kreativitas UPN
        Veteran Jawa Timur.
      </p>

      <p>
        Program ini bertujuan memberikan pengalaman belajar yang interaktif dan
        aplikatif kepada siswa melalui kegiatan pembelajaran dan praktik
        langsung.
      </p>

      <button>Daftar Volunteer</button>
      <button>Pelajari Program</button>
    </section>

    <!-- tentang proker upn mengajar -->
    <section id="tentang">
      <h2>Tentang UPN Mengajar</h2>

      <p>
        UPN Mengajar merupakan program pengabdian masyarakat di bidang
        pendidikan yang diselenggarakan oleh Bidang Pendidikan Sosial UKM
        Penalaran dan Kreativitas UPN Veteran Jawa Timur.
      </p>

      <p>
        Program ini mendukung tujuan pembangunan berkelanjutan khususnya SDGs 4
        yaitu Quality Education dengan menghadirkan kegiatan pembelajaran yang
        interaktif serta berbasis praktik.
      </p>

      <p>
        Melalui kegiatan ini mahasiswa dapat berkontribusi kepada masyarakat
        sekaligus mengembangkan kemampuan komunikasi, kepemimpinan, serta
        pengalaman mengajar secara langsung.
      </p>
    </section>

    <!-- kegiatan upn mengajar -->
...
<section class="w-full bg-gray-100 pt-0 pb-0">
  <!-- pt-28 = space buat navbar -->

  <div class="max-w-[20000px] mx-auto px-0">

    <img src="./foto/heroukm.png" 
         alt="UKM PNK"
...
<section class="min-h-screen flex items-center justify-center bg-white py-20">
  ...
  <div class="relative w-full max-w-6xl">
    ...
    <!-- FOTO -->
    <img src="./foto/kegiatanukm1.JPG"
      class="w-full h-[400px] md:h-[450px] object-cover grayscale shadow-lg">
    ...
    <div class="absolute inset-0 flex items-center justify-center text-center px-6">
      ...
      <div class="max-w-2xl">
        ...
        <p class="text-xs tracking-widest text-white/80 mb-2">
          WELCOME TO OUR COMMUNITY
        </p>

        <h1 class="text-2xl md:text-3xl font-semibold text-white leading-tight mb-3">
          UKM Penalaran & Kreativitas <br>
          UPN Veteran Jawa Timur
        </h1>

        <p class="text-white/80 text-sm leading-relaxed mb-6">
          UKM Penalaran dan Kreativitas merupakan wadah bagi mahasiswa untuk 
          mengembangkan kemampuan berpikir kritis, inovatif, dan solutif melalui 
          penelitian ilmiah dan pengembangan ide kreatif.

          Kami berkomitmen menciptakan lingkungan kolaboratif yang mendorong 
          mahasiswa untuk berkembang, berprestasi, dan memberikan dampak nyata 
          bagi masyarakat.
        </p>
        ...
        <div class="flex justify-center gap-6 mt-4">
          ...
          <a href="https://wa.me/6289699808453" target="_blank">
            <img src="./foto/icn-whatsapp.png" class="w-6 h-6 hover:scale-125 transition">
          </a>

          <a href="mailto:upnmengajar.jt@gmail.com">
            <img src="./foto/icn-email.png" class="w-6 h-6 hover:scale-125 transition">
          </a>

          <a href="https://instagram.com/upnmengajar.jt" target="_blank">
            <img src="./foto/icn-instagram.png" class="w-6 h-6 hover:scale-125 transition">
          </a>

          <a href="#" target="_blank">
            <img src="./foto/icn-linkedin.png" class="w-6 h-6 hover:scale-125 transition">
          </a>

          <a href="#" target="_blank">
            <img src="./foto/icn-tiktok.png" class="w-6 h-6 hover:scale-125 transition">
          </a>

          <a href="#" target="_blank">
            <img src="./foto/icn-x.png" class="w-6 h-6 hover:scale-125 transition">
          </a>
  ...
  <div class="flex justify-center items-center group">
    ...
    <div class="puzzle puzzle-left">
      <div class="puzzle-content">
        ...
        <p>
          Terwujudnya lingkungan kampus yang lebih akademis, 
          selaras dengan nilai-nilai Tridarma Perguruan Tinggi.
        </p>
      </div>
    </div>
    ...
    <div class="puzzle puzzle-right">
      <div class="puzzle-content">
        ...
        <ul class="list-disc ml-5 text-left">
          ...
          <li>Menghasilkan kader-kader yang kompetitif, inovatif, dan kreatif serta memiliki daya saing yang tinggi di bidang keilmuan, penelitian, dan pengabdian masyarakat.</li>
          <li>Berusaha menjadikan lingkungan kampus yang aman dan memiliki jiwa pengabdian pada masyarakat</li>
        </ul>
      </div>
    </div>
...
<section class="py-20">
  <div class="max-w-4xl mx-auto px-6 text-center">
    ...
    <!-- JUDUL -->
    <h2 class="text-3xl font-bold text-[#8B1E1E] mb-3">
      Badan Pengurus Harian
    </h2>

    <!-- SUB JUDUL -->
    <p id="roleTitle" class="text-lg text-gray-600 font-semibold mb-8">
      Ketua Umum
    </p>
    ...
    <div id="cardContainer" class="mb-4">
      ...
      <div class="card-role">
        <div class="flex justify-center">
          <div class="bg-white rounded-2xl shadow p-6 w-60 hover:shadow-xl transition">
            ...
            <img src="./foto/ketuaumum.png" class="rounded-full mx-auto mb-4">

            <h4 class="font-bold">Mayla Zaskia K</h4>
      ...
      <div class="card-role hidden">
        <div class="flex gap-6 justify-center flex-wrap">
          ...
          <div class="bg-white rounded-2xl shadow p-6 w-60">
            <img src="./foto/sekjen.png" class="rounded-full mx-auto mb-4">
            <h4 class="font-bold">Yanis Nabila J</h4>
            <p class="text-sm text-gray-500">Ekonomi Pembangunan '24</p>
          </div>

          <div class="bg-white rounded-2xl shadow p-6 w-60">
            <img src="./foto/sekre1.png" class="rounded-full mx-auto mb-4">
            <h4 class="font-bold">Putra Batara S W</h4>
            <p class="text-sm text-gray-500">Hukum '24</p>
          </div>

          <div class="bg-white rounded-2xl shadow p-6 w-60">
            <img src="./foto/sekre2.png" class="rounded-full mx-auto mb-4">
            <h4 class="font-bold">Hikmah Maulida</h4>
      ...
      <div class="card-role hidden">
        <div class="flex gap-6 justify-center flex-wrap">
          ...
          <div class="bg-white rounded-2xl shadow p-6 w-60">
            <img src="./foto/bendahara1.png" class="rounded-full mx-auto mb-4">
            <h4 class="font-bold">Dhanesia Vega Susila</h4>
            <p class="text-sm text-gray-500">Manajemen '24</p>
          </div>

          <div class="bg-white rounded-2xl shadow p-6 w-60">
            <img src="./foto/bendahara2.png" class="rounded-full mx-auto mb-4">
            <h4 class="font-bold">Syalsabilla Noer R</h4>
    ...
    <!-- BUTTON -->
    <div class="flex justify-center gap-10 mt-[-10px]">

  <button onclick="prevSlide()" 
    class="text-3xl text-[#8B1E1E] hover:scale-125 transition">
    ←
  </button>
...
<h2 class="text-3xl font-bold text-[#8B1E1E] mb-12">
Highlight Kegiatan
</h2>

<div class="grid md:grid-cols-3 gap-8">

<div class="rounded-2xl overflow-hidden shadow hover:shadow-xl transition">
...
<h4 class="font-bold">Workshop PKM</h4>

<p class="text-sm text-gray-600">
Pelatihan penulisan proposal Program Kreativitas Mahasiswa.
</p>
...
<img src="./foto/kegiatanukm2.JPG"
class="hover:scale-105 transition duration-300">

<div class="p-5">

<h4 class="font-bold">Seminar Nasional</h4>

<p class="text-sm text-gray-600">
Seminar inspiratif tentang inovasi mahasiswa.
</p>
...
<img src="./foto/kegiatanukm3.JPG"
class="hover:scale-105 transition duration-300">

<div class="p-5">

<h4 class="font-bold">Kompetisi Karya Ilmiah</h4>

<p class="text-sm text-gray-600">
Ajang kompetisi karya ilmiah mahasiswa.
</p>
...
=======
  <body class="font-[Poppins] bg-gray-50">
    ...
    <section
      class="relative pt-36 pb-28 text-white text-center bg-cover bg-center"
      style="background-image: url(&quot;./foto/ukm.jpg&quot;)"
    >
      <!-- Overlay -->
      <div class="absolute inset-0 bg-black/50"></div>
      ...
      <div class="relative max-w-5xl mx-auto px-6">
        <h1 class="text-5xl font-bold mb-6">UKM Penalaran & Kreativitas</h1>

        <p class="text-lg text-gray-200 max-w-2xl mx-auto">
          Unit kegiatan mahasiswa yang berfokus pada pengembangan riset,
          inovasi, dan kreativitas mahasiswa UPN "Veteran" Jawa Timur.
        </p>
      </div>
    </section>
    ...
    <section class="py-20">
      <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10">
        <div class="bg-white p-8 rounded-2xl shadow hover:shadow-xl transition">
          ...
          <p>
            Menjadi wadah pengembangan mahasiswa yang unggul dalam bidang
            penalaran, penelitian, dan kreativitas untuk menciptakan inovasi
        ...
        <div class="bg-white p-8 rounded-2xl shadow hover:shadow-xl transition">
          ...
          <ul class="list-disc ml-5 space-y-2">
            <li>Mengembangkan budaya riset di kalangan mahasiswa</li>
            <li>Mendorong inovasi dan kreativitas mahasiswa</li>
            <li>Mengikuti kompetisi ilmiah tingkat nasional</li>
            <li>Membangun kolaborasi akademik</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-white">
      <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div
            class="bg-gray-100 p-8 rounded-2xl shadow hover:shadow-xl transition"
          >
            <h3 class="font-bold text-xl mb-3">Penelitian</h3>

            <p>Mengembangkan kemampuan riset dan karya ilmiah mahasiswa.</p>
          </div>

          <div
            class="bg-gray-100 p-8 rounded-2xl shadow hover:shadow-xl transition"
          >
            <h3 class="font-bold text-xl mb-3">Kreativitas</h3>

            <p>Mendorong inovasi dan ide kreatif dalam berbagai bidang.</p>
          </div>

          <div
            class="bg-gray-100 p-8 rounded-2xl shadow hover:shadow-xl transition"
          >
            <h3 class="font-bold text-xl mb-3">Pengembangan SDM</h3>

            <p>
              Meningkatkan kualitas anggota melalui pelatihan dan mentoring.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="py-20">
      <div class="max-w-6xl mx-auto px-6 text-center">
        <h2 class="text-3xl font-bold text-[#8B1E1E] mb-12">Pengurus Inti</h2>

        <div class="grid md:grid-cols-4 gap-8">
          <div
            class="bg-white rounded-2xl shadow p-6 hover:shadow-xl transition"
          >
            <img src="./foto/martin.jpeg" class="rounded-full mx-auto mb-4" />
          ...
          >
            <img
              src="./foto/download (10).jpeg"
              class="rounded-full mx-auto mb-4"
            />

            <h4 class="font-bold">Sekretaris</h4>

            <p class="text-sm text-gray-500">Nama Sekretaris</p>
          </div>
          ...
          >
            <img
              src="./foto/download (15).jpeg"
              class="rounded-full mx-auto mb-4"
            />

            <h4 class="font-bold">Bendahara</h4>

            <p class="text-sm text-gray-500">Nama Bendahara</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="md:pl-10">
          ...
          <div class="space-y-3 text-sm">
            <div class="flex items-center gap-2">
              <img src="./foto/Untitled design (17).png" class="w-4 h-4" />
              <a href="mailto:upnmengajar.jt@gmail.com" class="hover:underline">
                upnmengajar.jt@gmail.coms
              </a>
            </div>

            <div class="flex items-center gap-2">
              <img src="./foto/instagram.png" class="w-4 h-4" />
              <a
            ...
            <div class="flex items-center gap-2">
              <img src="./foto/whatsapp.png" class="w-4 h-4" />
