...
CREATE TABLE `pendaftaran_relawan` (
  ...
  `pilihan_divisi_1` enum('Sekretaris','Bendahara','Acara','Humas','Perlengkapan','Konsumsi','PDD','Sponsorship') NOT NULL,
  `pilihan_divisi_2` enum('Sekretaris','Bendahara','Acara','Humas','Perlengkapan','Konsumsi','PDD','Sponsorship') NOT NULL,
...
INSERT INTO `users` VALUES (1,'Admin1','admin1@upnmengajar.com','admin123','admin'),(2,'Meineza','meineza@gmail.com','meineza','user');
...
-- Dump completed on 2026-04-12 19:49:25
