...
<<<<<<< HEAD
    ...
    <link href="https://fonts.googleapis.com/css2?family=Instrument+Serif&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        ...
        <div class="flex items-center gap-12">
            <nav>
                <ul class="flex gap-12 font-poppins font-semibold">
                    <li>
                        <a href="{{ url('/') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                            Home
                        </a>
                    </li>

                    <li class="relative group">
                        <a href="#" class="flex items-center gap-1 relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-full after:bg-white">
                            Tentang
                    ...
                    <li>
                        <a href="{{ url('/kegiatan') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                            Kegiatan
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/relawan') }}" class="relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                            Dokumentasi
                        </a>
                    </li>
                </ul>
            ...
            <div class="relative group">
                <a href="{{ url('/login') }}" class="hover:text-gray-300">
                ...
                <div class="absolute -bottom-10 left-1/2 -translate-x-1/2 bg-black/50 text-white text-xs px-3 py-2 opacity-0 group-hover:opacity-100 transition duration-200 whitespace-nowrap">
                    Log In
                </div>
            </div>
        ...
        <div class="absolute inset-0 flex items-center justify-center text-center px-6">
            <div class="max-w-2xl">
                ...
                <p class="text-white/80 text-sm leading-relaxed mb-6">
                    ...
                    penelitian ilmiah dan pengembangan ide kreatif. Kami berkomitmen menciptakan lingkungan kolaboratif yang mendorong mahasiswa untuk berkembang, berprestasi, dan memberikan dampak nyata bagi masyarakat.
                </p>
...
<footer class="bg-[#8B1E1E] text-white pt-16">
        ...
        <div class="md:pl-10">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ $medsos['instagram'] ?? '#' }}" class="hover:underline">@upnmengajar.jt</a>
                </div>
                <div class="flex items-center gap-2">
                    <img src="{{ asset('foto/whatsapp.png') }}" class="w-5 h-6">
                    <a href="{{ $medsos['whatsapp'] ?? '#' }}" class="hover:underline">089699808453 (Nabila)</a>
                </div>
            </div>
    ...
    <div class="bg-[#6e1515] px-6 md:px-20 py-4 flex flex-col md:flex-row justify-between text-sm text-gray-200">
        <p>© UKM Penalaran & Kreativitas UPN "Veteran" Jawa Timur</p>
...
<script>
    ...
    let currentIndex = 0; // Mengubah nama agar tidak tabrakan dengan index blade
...
<li class="relative group">
  <a href="javascript:void(0)"
     class="flex items-center gap-1 relative font-poppins font-semibold text-white cursor-pointer
            after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] 
            {{ request()->is('tentang') || request()->is('ukm') || request()->is('upnmengajar') || request()->is('tim') ? 'after:w-full' : 'after:w-0' }} 
