...
<html lang="id">
  ...
  <body class="bg-white font-poppins">
        ...
        <div class="flex items-center gap-12">
          <nav>
            <ul class="flex gap-12 font-poppins font-semibold items-center">
              ...
              <li>
                <a href="{{ route('admin.dashboard') }}" class="relative {{ request()->is('dashboard*') ? 'after:w-full' : 'after:w-0' }} after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                  Dashboard Admin
                </a>
              </li>
              @endif
    ...
    <main class="pt-0">
      <section class="relative h-[600px] w-full flex items-center justify-start overflow-hidden">
        <img src="{{ asset('foto/kegiatan3.jpg') }}" class="absolute inset-0 w-full h-full object-cover" alt="Hero Background" />
        <div class="absolute inset-0 bg-gradient-to-r from-[#8B1E1E] via-[#8B1E1E]/80 to-transparent"></div>

        <div class="relative z-10 px-12 md:px-24 text-white max-w-4xl">
          <span class="inline-block px-4 py-1 bg-white/20 backdrop-blur-md rounded-full text-sm font-medium mb-6">Program Kerja Bidang SOSIAL & PENDIDIKAN</span>
          <h1 class="text-6xl md:text-7xl font-bold mb-6 leading-tight">
            {{ $profil->vision ?? 'Mencerdaskan Bangsa Melalui Aksi Nyata.' }}
          </h1>
          <p class="text-lg md:text-xl opacity-90 mb-6 font-light leading-relaxed">
      ...
      <section class="py-24 px-8 md:px-24 bg-white">
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          <div class="relative">
            <div class="absolute -top-10 -left-10 w-40 h-40 bg-red-50 rounded-full z-0"></div>
            <h3 class="text-4xl font-bold text-gray-900 mb-8 relative z-10 leading-snug">
              Berpacu dengan <br /><span class="text-[#8B1E1E]">SDGs 4: Kualitas Pendidikan.</span>
            </h3>
            <p class="text-gray-600 text-lg leading-relaxed mb-6">
              Output utama kami adalah memastikan teknik pembelajaran yang diajarkan dapat diterapkan secara mandiri oleh peserta di lingkungan mereka secara berkelanjutan.
            </p>
            <div class="space-y-4">
              <div class="flex items-start gap-4">
                <p class="text-gray-700 font-medium">Pembelajaran Berbasis Eksperimen & Praktik Langsung.</p>
              </div>
              <div class="flex items-start gap-4">
                <p class="text-gray-700 font-medium">Kurikulum Inklusif untuk Semua Kalangan Masyarakat.</p>
              </div>
            </div>
          </div>

          <div class="grid grid-cols-2 gap-6">
            <div class="p-8 bg-[#8B1E1E] text-white rounded-[2rem] text-center transition duration-300 flex flex-col items-center justify-center">
              ...
              <p class="text-xs opacity-90 uppercase tracking-widest font-bold mb-2">Pertemuan / Lokasi</p>
              <div class="mt-2 pt-3 border-t border-white/20">
                <p class="text-[10px] leading-relaxed opacity-70 italic">Intensitas belajar optimal untuk <br />efektivitas penyampaian materi.</p>
              </div>
            </div>

            <div class="p-8 bg-white border-2 border-[#8B1E1E] rounded-[2rem] transition duration-300 flex flex-col justify-between">
              <div>
                <h4 class="text-lg font-bold text-gray-900 mb-2 leading-snug">Metodologi Pengajaran</h4>
            ...
            <div class="col-span-2 p-10 bg-red-50 rounded-[2rem] border border-red-100">
              <p class="text-[#8B1E1E] font-medium leading-relaxed italic">
                "Bukan hanya sekadar mengajar materi sekolah, tetapi kami membekali mereka dengan kreativitas untuk masa depan yang lebih cerah."
              </p>
            </div>
          </div>
        </div>
      ...
      <section class="py-24 bg-gray-50 px-8 md:px-24">
        <div class="max-w-7xl mx-auto">
          <div class="text-center max-w-2xl mx-auto mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Wilayah Jangkauan</h2>
            <p class="text-gray-500">Dari sekolah formal hingga komunitas inklusif, kami menjangkau setiap sudut yang membutuhkan sentuhan pendidikan.</p>
          </div>

          <div class="grid md:grid-cols-3 gap-10">
            <div class="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 transition duration-500">
              <div class="h-56 bg-gray-200 overflow-hidden relative">
                <img src="{{ asset('foto/sd.JPG') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="SD" />
              </div>
              <div class="p-10">
                <h4 class="text-2xl font-bold mb-4 text-gray-900">Sekolah Dasar (SD)</h4>
                <p class="text-gray-600 text-sm mb-8 leading-relaxed">Fokus pada literasi dan numerasi dasar melalui metode visual yang interaktif bagi anak-anak.</p>
                <div class="flex items-center mt-6">
                  <a href="{{ url('/kegiatan?kategori=sd') }}" class="bg-[#8B1E1E] text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-red-700 transition">Lihat Dokumentasi</a>
                </div>
              </div>
            </div>
            ...
            <div class="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 transition duration-500">
              <div class="h-56 bg-gray-200 overflow-hidden relative">
                <img src="{{ asset('foto/slb.JPG') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="SLB" />
              ...
              <div class="p-10">
                ...
                <p class="text-gray-600 text-sm mb-8 leading-relaxed">Memberikan dukungan pendidikan khusus dengan pendekatan emosional yang dirancang khusus.</p>
                <div class="flex items-center mt-6">
                  <a href="{{ url('/kegiatan?kategori=slb') }}" class="bg-[#8B1E1E] text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-red-700 transition">Lihat Dokumentasi</a>
                </div>
              </div>
            </div>
            ...
            <div class="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100 transition duration-500">
              <div class="h-56 bg-gray-200 overflow-hidden relative">
                <img src="{{ asset('foto/yayasan.jpg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Yayasan" />
              </div>
              <div class="p-10">
                <h4 class="text-2xl font-bold mb-4 text-gray-900">Yayasan & Komunitas</h4>
                <p class="text-gray-600 text-sm mb-8 leading-relaxed">Pendampingan belajar untuk anak-anak di panti asuhan maupun komunitas belajar jalanan.</p>
                <div class="flex items-center mt-6">
                  <a href="{{ url('/kegiatan?kategori=yayasan') }}" class="bg-[#8B1E1E] text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-red-700 transition">Lihat Dokumentasi</a>
                </div>
              </div>
            </div>
          </div> 
      ...
      <section class="py-24 bg-white px-8 md:px-24 relative overflow-hidden">
        <div class="max-w-5xl mx-auto bg-gradient-to-br from-gray-50 to-white border border-gray-100 rounded-[3rem] p-12 md:p-16 shadow-xl flex flex-col md:flex-row items-center justify-between gap-12">
          <div class="max-w-xl">
          ...
          <div class="w-full md:w-auto shrink-0">
            <a href="{{ url('/mitra') }}" class="group flex items-center justify-center gap-3 bg-[#8B1E1E] text-white px-8 py-4 rounded-2xl font-bold text-sm tracking-wide hover:bg-red-800 transition duration-300 w-full md:w-auto">
      ...
      <section id="gabung" class="pb-28 px-8 md:px-24 bg-white overflow-hidden relative">
        <div class="max-w-6xl mx-auto bg-gradient-to-r from-[#8B1E1E] to-[#6e1515] rounded-[3.5rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
          <div class="relative z-10 max-w-3xl mx-auto">
            <span class="text-xs text-white/60 font-bold uppercase tracking-widest mb-3 inline-block">Ambil Peranmu</span>
            <h2 class="text-4xl md:text-5xl font-extrabold text-white mb-6 tracking-tight leading-tight">Siap Menjadi Bagian dari Perubahan?</h2>
            <p class="text-white/80 text-base md:text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
            ...
            <a href="{{ url('/kegiatan') }}" class="group inline-flex items-center gap-3 bg-white text-[#8B1E1E] px-12 py-5 rounded-2xl font-extrabold text-lg hover:bg-gray-50 transition duration-300 uppercase tracking-wider transform">
      ...
      <div class="max-w-7xl mx-auto px-6 md:px-20 grid md:grid-cols-3 gap-10 pb-10">
        <div class="md:border-r md:border-red-300 md:pr-10">
          <div class="w-24 h-24 overflow-hidden mb-5">
            <img src="{{ asset('foto/logo.jpeg') }}" class="w-full h-full object-cover scale-150" alt="Logo Footer" />
          </div>
        ...
        <div class="md:pl-10">
          ...
          <div class="space-y-3 text-sm">
            <div class="flex items-center gap-2">
              <img src="{{ asset('foto/Untitled design (17).png') }}" class="w-5 h-6" alt="Email Icon" onerror="this.src='https://cdn-icons-png.flaticon.com/512/732/732200.png'"/>
              <a href="mailto:upnmengajar.jt@gmail.com" class="hover:underline">upnmengajar.jt@gmail.com</a>
            </div>
            <div class="flex items-center gap-2">
              <img src="{{ asset('foto/instagram.png') }}" class="w-5 h-6" alt="IG Icon" onerror="this.src='https://cdn-icons-png.flaticon.com/512/2111/2111463.png'"/>
              <a href="https://instagram.com/upnmengajar.jt" class="hover:underline">@upnmengajar.jt</a>
            </div>
            <div class="flex items-center gap-2">
              <img src="{{ asset('foto/whatsapp.png') }}" class="w-5 h-6" alt="WA Icon" onerror="this.src='https://cdn-icons-png.flaticon.com/512/733/733585.png'"/>
